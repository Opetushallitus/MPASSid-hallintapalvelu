...
const unflat = (config) => Object.entries(config).reduce((config, [key, value]) => set(config, key, value), {});
export default function createInit(configs) {
    return function init(options) {
        var _a, _b;
        const prefixes = toArray((_a = options === null || options === void 0 ? void 0 : options.prefix) !== null && _a !== void 0 ? _a : defaultOptions.prefix);
        const configOptions = toArray((_b = options === null || options === void 0 ? void 0 : options.config) !== null && _b !== void 0 ? _b : defaultOptions.config);
        globalThis.ENV = [
            ...configs,
            ...configOptions,
        ]
