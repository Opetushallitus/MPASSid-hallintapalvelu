...
test("luo uusi Opinsys-integraatio", async ({ page }) => {
  ...
  await page.getByPlaceholder("Lisää Client Key").fill("test-opinsys-client-key");
  await page.getByPlaceholder("Lisää Tenant ID").fill("test-opinsys-tenant-id");
