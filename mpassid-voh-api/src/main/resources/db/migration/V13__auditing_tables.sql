...
create table integration_group_history (
    id bigint not null,
    rev integer not null,
    revtype smallint,
    name varchar(255),
...
create table integrations_groups_history (
    rev integer not null,
    integration_id bigint not null,
    integration_group_id bigint not null,
    revtype smallint,
    primary key (rev, integration_id, integration_group_id)
);
/*
...
alter table
    integration_group_history
add
    constraint FKjruangxmh7ttu08qw0v036aur foreign key (rev) references extended_revinfo;

alter table
    integrations_groups_history
add
    constraint FK8dcbjegs60tre0go0o1gqh6tf foreign key (rev) references extended_revinfo;
